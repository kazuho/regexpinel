...
# Boundary 3: input is a raw pointer plus explicit length. The core's byte reads
# remain generated by Spinel; only the length source is redirected.
replace_exact!(
  source,
...
# Boundary 4: matches are reported through the extension callback.
replace_function!(
  source,
...
# Boundary 5: remove the proof executable entrypoint and expose the raw matcher
